...
#           t1 = time.time()
#           prediction = model(
#               enc_inputs[0].reshape(1,4,48), 
#               dec_inputs[0].reshape(1,20,48), 
#               enc_inputs_traj[0].reshape(1,4,3), 
#               dec_inputs_traj[0].reshape(1,20,3), 
...
def visualize_h36mdataset():
      ...
      parser = argparse.ArgumentParser()
      parser.add_argument('--config_file', type=str,default="/home/mohammad/Mohammad_ws/future_pose_prediction/potr/training/my_output26/config/config.json")
      parser.add_argument('--model_file', type=str,default="/home/mohammad/Mohammad_ws/future_pose_prediction/potr/training/my_output26/models/best_epoch_pose_0485.pt")
      parser.add_argument('--data_path', type=str, default="/home/mohammad/Mohammad_ws/future_pose_prediction/potr/data/h3.6m/")
      args = parser.parse_args()
...
#          trajectories.append(traj[:,[0,1]])
          ...
          for i in range(24,25):
              ...
              pos = np.concatenate((np.array([[0,0,0]]),pos),axis=0)
              #+ np.array([dx,0,dy])
              dx += 0.4
